...
{
	CPathManager::init();
	wstring strProjPath = CPathManager::GetProjectPath();
	...
	wstring strScriptIncludePath = CPathManager::GetIncludePath();
	...
	_wfopen_s(&pExeptList, L"exceptlist.txt", L"r");
	...
	// 두번째 함수 작성
	fwprintf_s(pFile, L"CScript * CScriptManager::GetScript(const wstring& _strScriptName)\n{\n");
	...
	// 세번째 함수
	fwprintf_s(pFile, L"CScript * CScriptManager::GetScript(UINT _iScriptType)\n{\n");
	...
	// 네번째 함수
	fwprintf_s(pFile, L"const wchar_t * CScriptManager::GetScriptName(CScript * _pScript)\n{\n");
